										...
										<div class="login ">
											...
											<input type="hidden" name="mode" value="modify">
												<fieldset style="border:0; color:black">
													...
													<div class="form-group">
														<label for="mem_password_re" class="col-sm-2 control-label">비밀번호확인</label>
														<div class="col-sm-5 ">
															<input type="password" class="form-control" id="mem_password_re" name="mem_password_re" placeholder="" aria-describedby="passwordReHelpBlock" required=""
													...
													<div class="form-group" style="padding-top:5px">
														<label for="mem_id" class="col-sm-2 control-label">성명</label>
														 <p class="form-control-static col-sm-6" style="margin-left:60px; margin-top:-5px"> 유민재</p>
													</div>
													
													<div class="form-group" style="margin-top:-50px;">
														<label for="mem_id" class="col-sm-2 control-label">생년월일</label>
														<div class="col-sm-4">
															<input type="text" class="form-control" name="mem_birth" id="mem_birth" value="19921103" required
															          style="border:1px solid black; width:160px; height:40px; color:black">
														</div>
													...
													<div class="form-group" style="padding-top:10px;">
														...
														<div class="col-sm-5">
															<span>
																<input type="checkbox" id="mem_email" name="mem_email" value="Y" 
